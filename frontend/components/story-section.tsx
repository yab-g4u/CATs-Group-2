      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 relative">
            ...
            <div className="mt-6 p-4 sm:p-6 glow-card rounded-2xl">
              <p className="text-foreground text-sm sm:text-base font-medium italic">
                &ldquo;I gave a blood sample, but when I returned to the treatment room, the lab had lost my sample.&rdquo;
              </p>
              <p className="text-muted-foreground text-sm mt-2">— Nadab, Patient</p>
            </div>
